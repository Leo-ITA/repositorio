                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item"
                                                href="eliminar.php?id=<?= $row['id'] ?>& usuario=<?= $row['usuario'] ?>">Eliminar</a></li>
                                        <li><a class="dropdown-item"
                                                href="verdocumentos.php?id=<?= $row['id'] ?>& usuario=<?= $row['usuario'] ?>">Ver documentos</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editUserForm" action="editar.php" method="post">
                        ...
                        <input type="hidden" name="usuario2" id="usuario_editar2">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="usuario_editar" name="nuevousuario" required>
                        </div>
                        <div class="form-group">
